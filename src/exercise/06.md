...
- If you are calling an async function in a useEffect, define the function in
  the useEffect and then call it in the useEffect rather than awaiting the async
  call in the useEffect directly.
- Group state together in an object when it makes sense.
